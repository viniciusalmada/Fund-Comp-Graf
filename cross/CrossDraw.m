...
%%%
% Initially prepared for the course CIV 2801 - Fundamentos de ComputaÃ§Ã£o
% GrÃ¡fica, 2019, second term, Department of Civil Engineering, PUC-Rio.
%
...
classdef CrossDraw < handle
    ...
    methods (Static)
        ...
        % artinit = articulação inicial. Apoio simples = 0, Engaste = 1,
        % Livre = 2
        % artend = articulação final. Apoio simples = 0, Engaste = 1, Livre
        % = 2
